...
class Test extends Server
{
  ...
  {
    // Consultar tabla cargos
    $search_cargo = $this->search(
      "SELECT c.id, c.name FROM cargos c",
      "Error al realizar la consulta",
      $this->info_msg("La consulta se realizo."),
      $this->success_msg("Consulta realizada"),
      $this->danger_msg("Error al consultar")
    );

    return $search_cargo['data'];
  }
  public function get_one($idTest = "")
  {
    ...
    if ($this->forms->empty_data($idTest)) {
      ...
      $search = $this->search(
        $this->querySelect . " where exam_id='$idTest'",
  ...
  public function get_all()
  {
    ...
    $search = $this->search(
      $this->querySelect . " left join configuracion_de_examen on configEx_examen=exam_id order by exam_nombre desc",
  ...
  public function get_questions_number($idTest = "")
  {
    ...
    $getQuestions = $this->search(
      "select count(preg_id) as questionsNumber from preguntas where preg_examen = '$idTest'",
  ...
  public function get_question(
    ...
    $searchQ = $this->search(
      "select preg_id, preg_pregunta from preguntas where preg_examen='$idTest' and preg_id='$idQuestion'",
  ...
  public function get_questions($idTest = "", $limit = "", $pageIni = "")
  {
    ...
    $searchQ = $this->search(
      "select preg_id, preg_pregunta from preguntas where preg_examen='$idTest' order by preg_id asc $pageIni $limit",
  ...
  public function get_questions_qualified($idTest = "", $userAnswers = "")
  {
    ...
    return $this->status_query(
      ...
      $getQuestions["notice"],
      array(
        "questions" => $olStart . $questionsList . $olEnd,
        "correctQuestions" => $correctNumber
      )
    );
  }

  public function write_questions(
    $data = "",
    $idTest = ""
  ) {
    ...
    while ($row = mysqli_fetch_assoc($data)) {
      ...
      $questions = $questions . $this->format_question(
        $row["preg_pregunta"],
        $row["preg_id"],
        $answers
      );
  ...
  public function format_question(
    $question = "",
    $idQuestion = "",
    $answers = ""
  ) {
  ...
  public function get_answer(
    ...
    $search = $this->search(
      "select resp_id, resp_texto from respuestas where resp_examen='$idTest' and resp_pregunta='$idQuestion' and resp_id='$idAnswer'",
  ...
  public function get_answers_list(
    ...
    $searchAns = $this->search(
      "select * from respuestas where resp_pregunta='$idQuestion' and resp_examen='$idTest'",
    ...
    if ($searchAns["status"] == "done") {
      ...
      $searchNumAns = $this->search(
        "select resp_id from respuestas where resp_pregunta='$idQuestion' and resp_examen='$idTest' and resp_correcta='1'",
  ...
  public function get_answers_qualified(
    $idQuestion = "",
    $idTest = "",
    $userAnswers = ""
  ) {
    ...
    if ($searchAns["status"] == "done") {
      ...
      while ($row = mysqli_fetch_assoc($searchAns["data"])) {
        ...
        if (
          isset($userAnswers[$row["resp_pregunta"]]) ||
          isset($userAnswers[$row["resp_pregunta"] . $row["resp_id"]])
        ) {

          if (
            isset($userAnswers[$row["resp_pregunta"]]) && $userAnswers[$row["resp_pregunta"]] == $row["resp_id"] ||
  ...
  public function get_correct_answers($idTest = "")
  {
    ...
    $getAns = $this->search(
      "select * from respuestas where resp_examen = '$idTest' and resp_correcta = '1'",
  ...
  public function get_data_expire($idTest = "")
  {
    ...
    $search = $this->search(
      "select *, exam_status from configuracion_de_examen inner join examenes on exam_id=configEx_examen where configEx_examen='$idTest'",
  ...
  public function get_test_name($idTest = "")
  {
    ...
    $search = $this->search(
      "select exam_nombre from examenes where exam_id='$idTest'",
  ...
  public function get_instructions($idTest = "")
  {
    ...
    $search = $this->search(
      "select exam_instrucciones from examenes where exam_id='$idTest'",
  ...
  public function get_test_data($idTest = '')
  {
    ...
    $search = $this->search(
      "select * from examenes inner join configuracion_de_examen on configEx_examen=exam_id where exam_id='$idTest'",
  ...
  public function get_data_test($idTest = "")
  {
    ...
    //instrucciones
    $searchIns = $this->search(
      "select * from examenes where exam_id='$idTest'",
    ...
    if ($getQuestions["status"] == "done") {
      ...
      $questions = $this->write_questions(
        $getQuestions["data"],
        $idTest
      );
    } else {
    ...
    return $this->status_query(
      $searchIns["status"] . $getQuestions["status"],
  ...
  public function get_config_testData($idTest = "")
  {
    ...
    //Primero preguntamos si ya tiene relacion con la tabla cc_e
    $sql_relation = "SELECT * FROM cc_e WHERE id_ce = '$idTest'";

    $search_relation = $this->search(
      $sql_relation,
      "Error al obtener la configuracion del examen relacionada",
      "Configuracion relacionada obtenida con exito",
      "Configuracion relacionada no encontrada para este examen",
      "Error al obtener la configuracion relacionada del examen"
    );
    ...
    if ($search["status"] == "done") {
      ...
      $data = array(
        "hourAp" =>  $testData["configEx_horaDeAplicacion"],
  ...
  public function set_test_name(
    ...
    if (
      !$this->forms->empty_data($testName) ||
      ...
      $setName = $this->crud(
        "update examenes set exam_nombre='$testName', exam_fechaActualizar='" . $this->date . "' where exam_id='$idTest'",
  ...
  public function set_test_config(
    ...
    if (!$this->forms->empty_data($idTest)) {
      ...
      $search = $this->search(
        "select configEx_id from configuracion_de_examen where configEx_examen='$idTest'",
        "Error al buscar examen",
        "Examen encontrado",
      ...
      if ($search["status"] == "done") {
        ...
        $config = $this->crud(
          "update configuracion_de_examen set configEx_horaDeAplicacion='$hourAp', configEx_fechaDeAplicacion='$dateAp', configEx_horaDeExpiracion='$hourEx', configEx_fechaDeExpiracion='$dateEx', configEx_promMin='$promMin' where configEx_examen='$idTest'",
          "Error al editar examen",
        ...
        $config = $this->crud(
          "insert into configuracion_de_examen (configEx_examen, configEx_horaDeAplicacion, configEx_fechaDeAplicacion, configEx_horaDeExpiracion, configEx_fechaDeExpiracion) values ('$idTest','$hourAp','$dateAp','$hourEx','$dateEx')",
  ...
  public function set_status_test(
    $status = "",
    $idTest = ""
  ) {
    ...
    if (
      !$this->forms->empty_data_two($status) ||
      !$this->forms->empty_data($idTest)
    ) {
      ...
      if ($status == "error") {
        ...
        $setOne = $this->crud(
          "update examenes set exam_status='$status', exam_fechaActualizar='" . $this->date . "' where exam_id='$idTest'",
          "Error al editar examen",
  ...
  public function set_question(
    ...
    if (
      !$this->forms->empty_data($question) ||
      !$this->forms->empty_data($idTest)
    ) {
      ...
      $setOne = $this->crud(
        "update preguntas set preg_pregunta='$question', preg_fechaActualizacion='" . $this->date . "' where preg_id='$idQuestion' and preg_examen='$idTest'",
  ...
  public function set_answer(
    ...
    if (
      ...
      $setOne = $this->crud(
        "update respuestas set resp_texto='$answer', resp_fechaActualizacion='" . $this->date . "' where resp_id='$idAnswer' and resp_pregunta='$idQuestion' and resp_examen='$idTest'",
  ...
  public function add_one($data = "")
  {
    ...
    if ($this->forms->empty_data($data)) {
      ...
      if (!$this->forms->empty_data($testName)) {
        ...
        $search = $this->search(
          "select exam_id, exam_nombre from examenes where exam_nombre='$nombre'",
  ...
  public function add_instructions(
    ...
    if (
      !$this->forms->empty_data($_POST["instructions"]) ||
      ...
      $addInst = $this->crud(
        "update examenes set exam_instrucciones='$instructions' where exam_id='$idTest'",
  ...
  public function add_question(
    ...
    if (
      !$this->forms->empty_data($_POST["question"]) ||
      !$this->forms->empty_data($_POST["idTest"])
    ) {
      ...
      $addQuestion = $this->crud(
        "insert into preguntas (preg_pregunta, preg_examen) values ('$question', '$idTest')",
      ...
      if ($getQuestions["status"] == "done") {
        ...
        $dataQuestion = $this->write_questions(
          $getQuestions["data"],
          $idTest
        );
      } else {
  ...
  public function add_answer(
    ...
    if (
      !$this->forms->empty_data($_POST["answer"]) ||
      ...
      $addAnswer = $this->crud(
        "insert into respuestas (resp_texto, resp_pregunta, resp_examen, resp_correcta, resp_fechaRegistro) values ('$answer', '$idQuestion', '$idTest', $correct, '$fechaRegistro')",
  ...
  public function add_correct_answer(
    $idQuestion = "",
    $idTest = "",
    $idAnswer = "",
    $correct = ""
    ...
    if (
      !$this->forms->empty_data($_POST["idAnswer"]) ||
      !$this->forms->empty_data($_POST["idQuestion"]) ||
      !$this->forms->empty_data($_POST["idTest"]) ||
      ...
      if ($correct == "1") {
        ...
        $update = $this->crud(
          "update respuestas set resp_correcta='0' where resp_examen='$idTest' and resp_pregunta='$idQuestion' and resp_id='$idAnswer'",
        ...
        $update = $this->crud(
          "update respuestas set resp_correcta='1' where resp_examen='$idTest' and resp_pregunta='$idQuestion' and resp_id='$idAnswer'",
  ...
  public function its_done_test($idTest = "", $idStudent = "")
  {
    ...
    if (
      ...
      $search = $this->search(
        "select * from examenes_realizados where er_examen='$idTest' and er_alumno='$idStudent'",
  ...
  public function save_test_results(
    ...
    if (
      ...
      $search = $this->search(
        "select er_id from examenes_realizados where er_examen='$test' and er_alumno='$student'",
      ...
      if ($search["status"] == "no-data") {
        ...
        $addTest = $this->crud(
          "insert into examenes_realizados (er_examen, er_alumno, er_correctas, er_incorrectas, er_promedio) values ('$test', '$student', '$correct','$incorrect', $promedio)",
  ...
  public function del_test($idTest = "")
  {
    ...
    if (!$this->forms->empty_data($idTest)) {
      ...
      $delTest = $this->crud(
        "delete from examenes where exam_id='$idTest'",
      ...
      $delEr = $this->crud(
        "delete from examenes_realizados where er_examen='$idTest'",
      ...
      $delQue = $this->crud(
        "delete from preguntas where preg_examen='$idTest'",
      ...
      $delAns = $this->crud(
        "delete from respuestas where resp_examen='$idTest'",
      ...
      $delConfig = $this->crud(
        "delete from configuracion_de_examen where configEx_examen='$idTest'",
  ...
  public function del_question(
    ...
    if (
      ...
      $delAns = $this->crud(
        "delete from respuestas where resp_pregunta='$idQuestion' and resp_examen='$idTest'",
      ...
      if ($delAns["status"] == "done") {
        ...
        $delOne = $this->crud(
          "delete from preguntas where preg_id='$idQuestion' and preg_examen='$idTest'",
  ...
  public function del_answer(
    ...
    if (
      ...
      $delAns = $this->crud(
        "delete from respuestas where resp_pregunta='$idQuestion' and resp_examen='$idTest' and resp_id='$idAnswer'",
        "Error al borrar la respuesta",
        "Respuesta borrada correctamente",
        "Error al borrar la respuesta"
      );
  ...
  public function del_student_er($idTest = "", $idStudent = "")
  {
    ...
    if (
      ...
      $delEr = $this->crud(
        "delete from examenes_realizados where er_examen='$idTest' and er_alumno='$idStudent'",
  ...
  public function get_doneTest_num($idStudent = "")
  {
    ...
    $search = $this->search(
      "select * from examenes_realizados inner join examenes on exam_id=er_examen where er_alumno = '$idStudent'",
  ...
  public function get_done_test($idStudent = "", $limit = "", $pageIni = "")
  {
    ...
    $search = $this->search(
      "select * from examenes_realizados inner join examenes on exam_id=er_examen inner join configuracion_de_examen on configEx_examen=er_examen  where er_alumno = '$idStudent' $pageIni $limit",
      "Error al buscar examenes",
      $this->success_msg("Mostrando examenes"),
      $this->info_msg("No se encontraron examenes realizados"),
      $this->danger_msg("Error al buscar examenes")
  ...
  public function get_student_testList($idStudent = "")
  {
    ...
    // usuario o alumno logeado
    $id_user = $_SESSION['sistemaExamenes']['idUser'];

    // cargo del user logeado o alumno
    $cargo_search = $this->search("SELECT a.cargo FROM alumnos a WHERE a.id = $id_user");

    // Preguntamos si encontro el alumno
    if ($cargo_search["status"]) {
      // Si lo encuentra solo mostramos los cargos para el
    ...
    if ($search["status"] == "done") {
      ...
      while ($row = mysqli_fetch_assoc($search["data"])) {
        ...
        if (
          ...
          $getTest = $this->search(
            "select er_examen from examenes_realizados where er_alumno = '$idStudent' and er_examen='$row[exam_id]'",
            "Error al buscar examenes",
            "Mostrando examenes",
