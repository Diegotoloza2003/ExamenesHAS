            ...
            <div class="content">
                ...
                <form action="<?php $_SERVER['PHP_SELF']?>" method="post" class="login-form" id="login-form" name="login-form">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="number" name="user" class="form-control" id="user" placeholder="Ingrese su cedula">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="password" name="password" class="form-control" id="pass" placeholder="Ingrese su contraseña">
                            </div>
                        </div>
